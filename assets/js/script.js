...
async function getAboutGithub() {
    try {
        ...
        const resposta = await fetch('https://api.github.com/users/fabricianalima');
        ...
        about.innerHTML = `
            ...
            <article class="about-content">
                <h2>Sobre mim</h2>
                <p>
                    Minha trajetória em tecnologia começou em 2022, e desde então participei de projetos para grandes empresas dos setores financeiro e saúde, atuando com desenvolvimento de aplicações, sustentação de sistemas, análise de requisitos e colaboração em times ágeis.
                </p>
                
                <p>
                    Atualmente, estou aprofundando meus conhecimentos em Java, Spring Boot, APIs REST, bancos de dados, React e boas práticas de desenvolvimento por meio do Bootcamp Full Stack Java da Generation Brasil.Este portfólio reúne meus estudos e projetos práticos, representando minha evolução como desenvolvedora e meu interesse em criar soluções que conectem tecnologia, negócio e a experiência dos usuários.
                </p>

                <div class="about-buttons-data">
                    <div class="buttons-container">
                        <a href="${perfil.html_url}" target="_blank" class="botao">Ver GitHub</a>
                        <a href="https://drive.google.com/file/d/1k63QYVqK5adkv6ADgZjTik5AR5NNRz9C/view?usp=sharing" target="_blank" class="botao-outline">Currículo</a>
                    </div>
...
async function getProjectsGithub() {
    try {
        ...
        // Não esqueça de trocar conteudoGeneration pelo seu usuário do GitHub
        const resposta = await fetch('https://api.github.com/users/fabricianalima/repos?sort=updated&per_page=6');
